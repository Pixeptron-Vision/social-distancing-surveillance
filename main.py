    ...
    if not ret or frame1 is None:
        ...
        while True:
            ...
            if not ret or current_frame is None:
                ...
                contours,(centres,boxed_current_frame) = activity_filter(current_frame,background_frame)
                ...
                user_exit = display_obj.update(boxed_current_frame,motion_frame,background_frame)
